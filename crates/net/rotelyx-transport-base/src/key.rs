//! Cryptographic key handling for `rotelyx_transport`.
...
/// The identifier for an endpoint in the (rotelyx_transport) network.
///
/// Each endpoint in rotelyx_transport has a unique identifier created as a cryptographic key.  This can be
