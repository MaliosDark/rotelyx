...
fn test_whatever() {
    ...
    fn fail() -> Result {
        rotelyx_error::bail_any!("sad face");
    }
    ...
    fn fail_whatever() -> Result {
        rotelyx_error::try_or_any!(fail(), "sad");
        Ok(())
    }

    fn fail_whatever_my_error() -> Result {
        rotelyx_error::try_or_any!(fail_my_error(), "sad");
        Ok(())
    }

    rotelyx_error::set_backtrace_enabled(false);
    assert!(fail().is_err());
    ...
    rotelyx_error::set_backtrace_enabled(true);
