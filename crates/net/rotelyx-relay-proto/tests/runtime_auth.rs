...
//!
//! [`AccessControl`]: rotelyx_relay_proto::server::AccessControl
//! [`Clients::disconnect`]: rotelyx_relay_proto::server::clients::Clients::disconnect
        ...
        loop {
            ...
            match msg {
                ...
                RelayToClientMsg::Pong(echo) => {
                    rotelyx_error::ensure_any!(echo == data, "pong mismatch");
                    break;
                }
                other => rotelyx_error::bail_any!("expected pong, got {other:?}"),
            }
        }
        rotelyx_error::Ok(())
    })
