//! TLS verification configuration for rotelyx_transport and rotelyx_transport-relay.
...
/// Configures the trusted CA root certificates for non-rotelyx_transport TLS connections.
///
/// These roots are used whenever rotelyx_transport establishes standard TLS connections to
/// external services, such as rotelyx_transport relays, pkarr servers, or DNS-over-HTTPS
/// resolvers.
///
