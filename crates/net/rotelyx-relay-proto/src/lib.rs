//! Iroh's relay is a feature within [rotelyx_transport](https://github.com/n0-computer/rotelyx_transport), a peer-to-peer
...
//!
//! This crate provides a complete setup for creating and interacting with rotelyx_transport relays, including:
...
#![cfg_attr(
    feature = "server",
    doc = "- [`server`]: A fully-fledged rotelyx_transport-relay server over HTTP or HTTPS."
)]
#![cfg_attr(
    not(feature = "server"),
    doc = "- `server`: A fully-fledged rotelyx_transport-relay server over HTTP or HTTPS."
