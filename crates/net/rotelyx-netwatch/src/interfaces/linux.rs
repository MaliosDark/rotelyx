...
mod sane {
    use rotelyx_error::e;
    use rotelyx_future::{Either, StreamExt, TryStream};
    ...
    fn get_route(
        ...
        match handle.request(req, netlink_proto::sys::SocketAddr::new(0, 0)) {
            ...
            Err(e) => Either::Right(rotelyx_future::stream::once::<Result<RouteMessage, Error>>(Err(
                e!(Error::Netlink, e),
            ))),
        }
    }
    ...
    fn get_link(
        ...
        match handle.request(req, netlink_proto::sys::SocketAddr::new(0, 0)) {
            ...
            Err(e) => Either::Right(rotelyx_future::stream::once::<Result<LinkMessage, Error>>(Err(
                e!(Error::Netlink, e),
            ))),
        }
    }
