//! Patchbay network simulation tests for rotelyx_netwatch.
//!
//! These tests use the [`patchbay`] crate to create virtual network topologies
//! in Linux user namespaces, testing rotelyx_netwatch's interface and route detection
...
use rotelyx_netwatch::interfaces::State;
...
/// After replugging from a v4 router to a v6 router, rotelyx_netwatch detects the new
/// default route.
#[tokio::test]
