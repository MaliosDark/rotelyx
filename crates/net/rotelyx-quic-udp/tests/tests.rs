...
use rotelyx_quic_udp::{EcnCodepoint, RecvMeta, Transmit, UdpSocketState};
use socket2::Socket;
...
fn test_send_recv(send: &Socket, recv: &Socket, transmit: Transmit<'_>) {
    ...
    while datagrams < expected_datagrams {
        ...
        // Disable SO_TIMESTAMPNS for now: https://github.com/n0-computer/rotelyx_quic/issues/774
