...
//! retract endpoint addressing information that is otherwise out-of-band to rotelyx_transport.
//!
//! [`EndpointTicket`]: https://docs.rs/rotelyx_transport-tickets/latest/iroh_tickets/endpoint/struct.EndpointTicket.html
...
impl MemoryLookup {
    ...
    /// addressing information used by an rotelyx_transport [`Endpoint`].
    ///
    ...
    ///
    /// use rotelyx_transport::{Endpoint, EndpointAddr, address_lookup::memory::MemoryLookup, endpoint::presets};
    ///
...
mod tests {
    ...
    use rotelyx_error::{Result, StackResultExt};
