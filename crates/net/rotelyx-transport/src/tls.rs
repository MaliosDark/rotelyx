//! TLS configuration for rotelyx_transport.
//!
...
use rotelyx_quic::crypto::rustls::{QuicClientConfig, QuicServerConfig};
use tracing::warn;
...
pub use rotelyx_relay_proto::tls::CaRootsConfig;
pub use rotelyx_relay_proto::tls::CaTlsConfig;
#[cfg(with_crypto_provider)]
pub use rotelyx_relay_proto::tls::default_provider;
...
#[allow(missing_docs)]
#[rotelyx_error::stack_error(derive, add_meta, from_sources)]
#[non_exhaustive]
pub enum TlsConfigError {
    ...
    CryptoProviderNoInitialCipherSuite {
        #[error(std_err)]
        source: rotelyx_quic::crypto::rustls::NoInitialCipherSuite,
    },
    #[error("The configured crypto provider is incompatible with rotelyx_transport and QUIC encryption")]
