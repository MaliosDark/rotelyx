...
//! in Linux user namespaces, testing rotelyx_transport's NAT traversal, holepunching,
...
//! cargo nextest run -p rotelyx_transport --test patchbay --profile patchbay
...
//! patchbay test --release -p rotelyx_transport --test patchbay
//! ```
...
use ipnet::Ipv4Net;
use rotelyx_transport::endpoint::Side;
