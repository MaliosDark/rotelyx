...
impl TransportConfig {
    ...
    /// # use rotelyx_quic_proto::{TransportConfig, VarInt, VarIntBoundsExceeded};
    ...
    /// # Example
    /// ```
    /// # use rotelyx_quic_proto::*; use std::sync::Arc;
    /// let mut config = TransportConfig::default();
...
///
/// rotelyx_quic's implementation follows the fourth draft of the
...
///
/// rotelyx_quic implements MTU discovery through DPLPMTUD (Datagram Packetization Layer Path MTU
...
/// is 65527), rotelyx_quic performs a binary search to keep the number of probes as low as possible. The
...
/// # use rotelyx_quic_proto::{IdleTimeout, VarIntBoundsExceeded, VarInt};
/// # fn main() -> Result<(), VarIntBoundsExceeded> {
