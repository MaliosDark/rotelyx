...
///
/// This is a regression test. See <https://github.com/n0-computer/rotelyx_quic/issues/435>
#[test]
...
fn abandon_path_data_continues() -> TestResult {
    ...
    // In rotelyx_quic, we check that path 0 is abandoned and path 1 is still alive.
    assert!(
...
fn regression_delayed_path_cids_blocked() -> TestResult {
    ...
    // being put into a separate datagram. See also <https://github.com/n0-computer/rotelyx_quic/issues/66>
