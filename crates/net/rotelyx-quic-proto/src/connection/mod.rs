...
impl Connection {
    ...
    fn poll_transmit_path_space(
        ...
        loop {
            ...
            if scheduling_info.may_send_close && can_send.close {
                ...
                //    https://github.com/n0-computer/rotelyx_quic/issues/367.
                debug_assert!(
    ...
    //    See https://github.com/n0-computer/rotelyx_quic/issues/607.
    ...
    /// completed.
    ///
    /// It is noteworthy that for rotelyx_transport we allow server migrations during the handshake when
    ...
    // lacking <https://github.com/n0-computer/rotelyx_quic/issues/364>
    ...
    ///
    /// TODO(matheus23): This is related to rotelyx_quic endpoint state's `ipv6` bool. We should move that info
