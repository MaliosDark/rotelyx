...
//!
//! rotelyx_quic-proto contains a fully deterministic implementation of QUIC protocol logic. It contains
//! no networking code and does not get any relevant timestamps from the operating system. Most
//! users may want to use the futures-based rotelyx_quic API instead.
//!
//! The rotelyx_quic-proto API might be of interest if you want to use it from a C or C++ project
