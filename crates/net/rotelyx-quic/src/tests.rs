...
async fn zero_rtt() {
    ...
    let accept_connection = move |expect_0rtt| {
        ...
        async move {
            ...
            // Filed https://github.com/n0-computer/rotelyx_quic/issues/463 to investigate this
            // in the future.
...
fn run_echo(args: EchoArgs) {
    ...
    let handle = {
        ...
        let handle = runtime.spawn(async move {
            ...
            // platforms in the doc comment of `rotelyx_quic_udp::RecvMeta::dst_ip`.
...
/// already discarded but cached in the rotelyx_quic layer's final stats.
#[tokio::test]
async fn closed_includes_path_stats_for_all_known_paths() -> TestResult {
    ...
    let client_task = async move {
        ...
        // alive past the discard so the final stats land in rotelyx_quic's
