...
//! builds on top of rotelyx_quic-proto, which implements protocol logic independent of any particular
//! runtime.
//!
...
//! raw UDP sockets.
//!
//! rotelyx_quic also exposes unreliable datagrams, which are a low-level primitive preferred when
