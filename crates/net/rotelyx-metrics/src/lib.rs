//! Metrics library for rotelyx_transport
...
///
/// ```
/// use rotelyx_metrics::EncodeLabelSet;
///
...
/// }
/// ```
pub use rotelyx_metrics_derive::EncodeLabelSet;
...
pub use rotelyx_metrics_derive::EncodeLabelValue;
...
/// the field type, so `rotelyx_metrics::Family<L, M>` is recognized but a type
...
pub use rotelyx_metrics_derive::MetricsGroup;
...
pub use rotelyx_metrics_derive::MetricsGroupSet;

// This lets us use the derive metrics in the lib tests within this crate.
extern crate self as rotelyx_metrics;

use std::collections::HashMap;

/// Potential errors from this library.
#[rotelyx_error::stack_error(derive, add_meta, from_sources, std_sources)]
#[non_exhaustive]
#[allow(missing_docs)]
pub enum Error {
